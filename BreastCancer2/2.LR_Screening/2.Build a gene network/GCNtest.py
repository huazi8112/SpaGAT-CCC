...
data_path = BASE_DIR.parent / "1.Data preprocessing" / "t_wavelet-all-R-A2.mat"
mat = sio.loadmat(data_path)
if 't_data' not in mat:
    raise KeyError(f"'t_data' not found in {data_path}")
if 'point' not in mat:
    raise KeyError(f"'point' not found in {data_path} (needed for prewavelet-L-A2.mat / c_index0.m)")
...
df_avg.to_excel(BASE_DIR / 'R-averaged_final_adj-A2.xlsx', index=False, header=False)

# Same as getpre.m: bundle for c_index0.m (loads prewavelet-L-A2.mat)
sio.savemat(
    str(BASE_DIR / 'prewavelet-R-A2.mat'),
    {

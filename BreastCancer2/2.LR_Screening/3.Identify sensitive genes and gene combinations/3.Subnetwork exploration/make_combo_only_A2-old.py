"""A2版本：生成 combo_only-A2.csv

来源1：
- new_name-L-thresh0.04-A2.mat
- new_name-R-thresh0.07-A2.mat
按笛卡尔积组合，并去掉同细胞类型配对。

来源2：
- BreastCancer2/5.Results/OtherMethods/InputData/runModel/LRTG_allscore_*.rds
...
# 与脚本分目录：集中在 OtherMethods/InputData/runModel（LRTG_allscore_*.rds）
RUNMODEL_DIR = os.path.normpath(
    os.path.join(
        SCRIPT_DIR,
        "..",
        "..",

...
来源1：
- new_name-L0.45-A2.mat
- new_name-R0.01-A2.mat
按笛卡尔积组合，并去掉同细胞类型配对。

来源2：
- BreastCancer2/5.Results/OtherMethods/InputData/runscMLnet/**/scMLnet.rds
...
# BreastCancer2: 5.Results/OtherMethods/InputData/runscMLnet（内含 **/scMLnet.rds）

...
load(fullfile(script_dir, '..', '..', '2.Build a gene network', 'prewavelet-R-A2.mat'))
load(fullfile(script_dir, '..', '1.Initial network entropy index calculation', 'init_indext_wavelet-R-A2.mat'))
...
savefig(gcf, fullfile(script_dir, 'final-plot-R-A2.fig'));
save(fullfile(script_dir, 'adduwavelet-100-(all)-R-(-0.3)-A2.mat'), 'H_point_value');
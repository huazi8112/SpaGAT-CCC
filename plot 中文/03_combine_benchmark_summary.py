...
def draw_benchmark_workflow(ax):
    ...
    def draw_section_box(x, y, w, h, title):
        ...
        ax.text(x + w / 2, y + h - 0.23, title, ha="center", va="center",
                fontsize=sz(22), fontweight="bold", zorder=3,
    ...
    # ── SECTION 1: Input ──
    draw_section_box(0.3, 0.3, 4.0, 6.9, "输入")

    ax.text(0.65, 6.45, "基因表达矩阵", fontsize=sz(12), fontweight="bold",
            fontfamily="Microsoft YaHei")
    ...
    ax.text(0.65, 4.05, "坐标信息", fontsize=sz(12), fontweight="bold",
            fontfamily="Microsoft YaHei")
    ...
    ax.text(0.65, 2.45, "细胞类型元数据", fontsize=sz(12), fontweight="bold",
            fontfamily="Microsoft YaHei")
    tm_x, tm_y = 0.85, 1.5
    for r in range(2):
        for c in range(5):
    ...
    # ── SECTION 3: Benchmark ──
    draw_section_box(9.2, 0.3, 7.5, 6.9, "基准测试")

    ax.text(10.0, 6.3, "已验证的配体-受体对", fontsize=sz(12), fontweight="bold", color="#c62828",
            fontfamily="Microsoft YaHei")
    ...
    ax.text(bar_x + 1.0, bar_y + 0.82, "正例", fontsize=sz(10),
            ha="center", color="#2e7d32", fontweight="bold",
            fontfamily="Microsoft YaHei")
    ax.text(bar_x + 3.6, bar_y + 0.82, "负例", fontsize=sz(10),
            ha="center", color="#757575", fontweight="bold",
            fontfamily="Microsoft YaHei")

    ax.text(10.0, 4.85, "预测的配体-受体分数", fontsize=sz(12), fontweight="bold", color="#1565c0",
            fontfamily="Microsoft YaHei")
    score_y = 3.95
    ...
    ax.text(cm_x + cm_s, cm_y + 2 * cm_s + 0.12, "混淆矩阵",
    ...
    big_arrow(8.4, 3.75, 9.2, 3.75, text="配体-受体分数")
...
def draw_performance_bar(subfig):
    ...
    for col, metric in enumerate(metrics):
        ...
        ax.set_ylabel("分数", fontsize=18, fontfamily="Microsoft YaHei")
...
def draw_methods_table(ax):
    ...
    ax.text(x0 + col0_w / 2, top_y - header_h / 2, "方法",
            ha="center", va="center", fontsize=20, fontweight="bold",
            color=HEADER_TEXT, zorder=4, fontfamily="Microsoft YaHei")
    ...
    for j, func in enumerate(functionalities):
        ...
        ax.text(fx + col_w / 2, top_y - header_h * 0.4 - header_h * 0.3,
                ...
                linespacing=1.15, fontfamily="Microsoft YaHei")

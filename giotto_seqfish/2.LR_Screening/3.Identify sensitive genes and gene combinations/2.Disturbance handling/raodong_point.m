...
load(fullfile(script_dir, '..', '1.Initial network entropy index calculation', 'init_indext_wavelet-R-A3.mat'))
...
savefig(gcf, fullfile(script_dir, 'final-plot-R-A3.fig'));
save(fullfile(script_dir, 'adduwavelet-100-(all)-L-(0.2)-A3.mat'), 'H_point_value');
...
来源1：
- new_name-L-thresh0.025-A3.mat
- new_name-R-thresh0.067-A3.mat
按笛卡尔积组合，并去掉同细胞类型配对。

来源2：
- giotto_seqfish/5.Results/OtherMethods/InputData/runscMLnet/**/scMLnet.rds
...
# 与脚本分目录：集中放在 OtherMethods/InputData/runscMLnet（内含 **/scMLnet.rds）
...
MAT_L = os.path.join(SCRIPT_DIR, "new_name-L0.21-A3.mat")
MAT_R = os.path.join(SCRIPT_DIR, "new_name-R0.002-A3.mat")
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "combo_only-A3.csv")

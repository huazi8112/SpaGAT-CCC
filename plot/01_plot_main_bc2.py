...
def draw_sankey(ax, top30):
    ...
    ax.text(x_left + bar_w / 2, 1.055, "Sender\nCell Type",
            ha="center", fontsize=FS.SUBTITLE, fontweight="bold")
    ax.text(xm, 1.055, "Ligand-Receptor (Att Score)",
            ha="center", fontsize=FS.SUBTITLE, fontweight="bold")
    ax.text(x_right - bar_w / 2, 1.055, "Receiver\nCell Type",
            ha="center", fontsize=FS.SUBTITLE, fontweight="bold")
    ...
    ax.axis("off")
    ax.set_title("B. Cell-Type Communication Flow (Sankey, Top 30)",
                 fontsize=FS.TITLE, fontweight="bold", pad=18)
...
def draw_edge_bundling(ax, top60):
    ...
    ax.set_aspect("equal")
    ax.axis("off")
    ax.set_title("C. Hierarchical Edge Bundling (Top 60)",
                 fontsize=FS.TITLE, fontweight="bold", pad=14)
    ...
    leg = ax.legend(handles=handles, loc="lower center",
                    ...
                    fontsize=FS.LEGEND,
                    title="Cell Type", title_fontsize=FS.LEGEND_TITLE,

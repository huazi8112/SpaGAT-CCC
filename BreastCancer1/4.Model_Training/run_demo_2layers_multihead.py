...
lig_df = pd.read_csv(scoring_dir / "ligand_expr_by_cell_filtered.csv", index_col=0)
rec_df = pd.read_csv(scoring_dir / "receptor_expr_by_cell_filtered.csv", index_col=0)
...
adata = train_STAGATE(
    ...
    lr_score_rds=scoring_dir / "LR_scores_all_pairs_V0_meta_gpu.csv",
    ligand_section="s1",
    receptor_section="s2",

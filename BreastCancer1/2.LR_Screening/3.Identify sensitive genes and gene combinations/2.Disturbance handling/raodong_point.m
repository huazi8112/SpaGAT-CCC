...
load(fullfile(script_dir, '..', '1.Initial network entropy index calculation', 'init_indext_wavelet-R.mat'));
...
savefig(gcf, 'final-plot-L-A1.fig');


save adduwavelet-100-(all)-R-(-0.3)-A2.mat H_point_value;
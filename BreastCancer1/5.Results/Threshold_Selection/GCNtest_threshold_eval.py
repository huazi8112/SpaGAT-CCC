...
data_path = (BASE_DIR.parent.parent
             / "2.LR_Screening" / "1.Data preprocessing" / "t_wavelet-all-L.mat")
...
df_all.to_csv(BASE_DIR / 'threshold_sync_eval-L.csv', index=False)

df_t06 = df_all[np.isclose(df_all["sync_threshold"], REPORT_BIN_THRESHOLD)].copy()
# df_t06.to_csv(BASE_DIR / 'threshold_sync_eval-t0.6-.csv', index=False)
...
#     BASE_DIR / 'L-averaged_final_adj-sync-best-.xlsx',
#     index=False,
#     header=False,
# )

...
PREPROC = ROOT.parent / "1.Preprocessing"
COMBO_PATH = (
    ROOT.parent
    / "2.LR_Screening"
...
LIGAND_IN = PREPROC / "ligand_expr_by_cell.csv"
RECEPTOR_IN = PREPROC / "receptor_expr_by_cell.csv"
# Keep filtered matrices next to the canonical raw tables (1.Preprocessing only).
LIGAND_OUT = PREPROC / "ligand_expr_by_cell_filtered.csv"
RECEPTOR_OUT = PREPROC / "receptor_expr_by_cell_filtered.csv"
